                            ...
                            <div class="media-left">
                                <figure class="image is-64x64">
                                    <img style="border-radius: 0.5em"
                                         src="/static/images/regexplore-img.png"
                                         alt="Image">
                                </figure>
                            </div>
                  ...
                  <div class="box">
                        <article class="media">
                            <div class="media-left">
                                <figure class="image is-64x64">
                                    <img style="border-radius: 0.5em"
                                         src="https://avatars2.githubusercontent.com/u/37457770?s=200&v=4"
                                         alt="Image">
                                </figure>
                            </div>
                            <div class="media-content">
                            ...
                            <div class="media-content">
                                <div class="content">
                                    <p><!--title-->
                                        ...
                                        <b> Laravel Web Framework, Machine Learning , Python, Scikit-Learn ,PHP ,
                                            JQuery</b>
                                    </p>
                                </div><!--font-awesome icons-->
                            </div>
