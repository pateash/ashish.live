<template>
    ...
    <div class="inner-item">
        ...
        <p align="center"><img :src="images[0]" @click="index = 0"></p>
        ...
        <p align="center"><img style='margin:1em;'  :src="images[1]" @click="index = 1"  alt="proxyQuery" /></p>
        <br>
        <h4 id="mist-server">Mist Server</h4>
        <p style="font-size:1em">
        <p style="font-size:1em;" ><img align="left" :src="images[2]" @click="index = 2" alt="proxyQuery" width="200" height="100" style="margin:1em;" /></p>
        ...
        <p>
        <p ><img  align="left" :src="images[3]" @click="index = 3" style="margin:1em;" alt="Spark" width="200" height="100" /></p>
