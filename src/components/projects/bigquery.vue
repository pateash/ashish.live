<template>
    ...
    <div class="inner-item">
        ...
        <p align="center"><img src="https://imgd.aeplcdn.com/0x0/bigquery/bigquery_architecture.png"></p>
        ...
        <p align="center"><img style='margin:1em;' src="/static/images/ProxyQuery.jpg" alt="proxyQuery" /></p>
        <br>
        <h4 id="mist-server">Mist Server</h4>
        <p style="font-size:1em">
        <p style="font-size:1em;" ><img align="left" src="/static/images/mist.png" alt="proxyQuery" width="200" height="100" style="margin:1em;" /></p>
        ...
        <p>
        <p ><img  align="left" src="/static/images/spark.png"  style="margin:1em;" alt="Spark" width="200" height="100" /></p>
